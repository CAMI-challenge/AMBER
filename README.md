...
3. A FASTA or FASTQ file with the sequences for obtaining their lengths. Optionally, the lenghts may be added to the gold standard mapping file at column _LENGTH using tool _utils/add_length_column.py_ (see [README_TOOLS.md](./README_TOOLS.md#add_length_columnpy)). In this way, _evaluate.py_ no longer requires a FASTA or FASTQ file.
